...
func TestGetPayload(t *testing.T) {
	...
	require.EqualError(t, err, "Expect 1 inputs other than 2 inputs")
	_, err = GetPayload("Balance.abi", "set", []string{})
	require.EqualError(t, err, "Expect 1 inputs other than 0 inputs")
	...
	require.EqualError(t, err, "Expect 0 inputs other than 1 inputs")
}
