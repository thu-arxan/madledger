...
func (*NodeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_877bd63e92de5f4b, []int{0}
}
...
func (*AddNodeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_877bd63e92de5f4b, []int{1}
}
...
func (*RemoveNodeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_877bd63e92de5f4b, []int{2}
}
...
type RaftClient interface {
	// AddNode add a new node join a cluster
	AddNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*AddNodeResponse, error)
	// RemoveNode remove an old node from a cluster
	RemoveNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*RemoveNodeResponse, error)
}
...
func (c *raftClient) AddNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*AddNodeResponse, error) {
	out := new(AddNodeResponse)
	err := c.cc.Invoke(ctx, "/protos.Raft/AddNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) RemoveNode(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*RemoveNodeResponse, error) {
	out := new(RemoveNodeResponse)
	err := c.cc.Invoke(ctx, "/protos.Raft/RemoveNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServer interface {
	...
	// RemoveNode remove an old node from a cluster
	RemoveNode(context.Context, *NodeInfo) (*RemoveNodeResponse, error)
}
...
func _Raft_AddNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.Raft/AddNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServer).AddNode(ctx, req.(*NodeInfo))
	}
...
func _Raft_RemoveNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.Raft/RemoveNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServer).RemoveNode(ctx, req.(*NodeInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("raft.proto", fileDescriptor_raft_877bd63e92de5f4b) }

var fileDescriptor_raft_877bd63e92de5f4b = []byte{
	...
	0x97, 0x50, 0x50, 0x6a, 0x6e, 0x7e, 0x59, 0x2a, 0xb2, 0xa8, 0x51, 0x05, 0x17, 0x4b, 0x50, 0x62,
	0x5a, 0x89, 0x90, 0x09, 0x17, 0x3b, 0x54, 0x83, 0x90, 0x00, 0xc4, 0x5d, 0xc5, 0x7a, 0x30, 0xd7,
	0x48, 0x89, 0xc3, 0x44, 0xd0, 0xcc, 0x14, 0xb2, 0xe2, 0xe2, 0x42, 0x98, 0x89, 0x45, 0xa3, 0x14,
	0x4c, 0x04, 0xd3, 0xe6, 0x24, 0x88, 0xb7, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x8b, 0xe6,
	0x30, 0x5a, 0x0b, 0x01, 0x00, 0x00,
}
