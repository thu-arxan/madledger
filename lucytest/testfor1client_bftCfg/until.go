...
func addNode() error {
	// construct PubKey
	data, err := base64.StdEncoding.DecodeString("J0juvEKWlK6FAjw4b/oTMM7EYIH1NpHeNOcZ65tIHP8=")
	if err != nil {
		return err
	}
	pubkey := types.PubKey{
	...
	tx, err := coreTypes.NewTx("test0", coreTypes.CfgTendermintAddress, validatorUpdate, bftAdmin.GetPrivKey(), coreTypes.VALIDATOR)
	if err != nil {
		return err
	}
