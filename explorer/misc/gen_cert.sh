...
openssl req -x509 -new -nodes -key localhostCA.key -passin pass:$CA_PASSWORD -config localhostCA.conf -sha256 -days 500 -out localhostCA.pem
...
-out localhost.crt -days 400 -sha256 -extfile localhost.conf -passin pass:$CA_PASSWORD
