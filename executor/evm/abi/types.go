...
// EVMType define the function of type in EVM should contains
...
// EVMInt is the int, includes {int8, int16, int32, int64, big.Int}
type EVMInt struct {
	M uint64
}
...
// Argument defines the properties of argument
...
// FunctionIDSize means that the name of function need space which is 4 bytes
const FunctionIDSize = 4

// FunctionID is the bytes which length is FunctionIDSize
type FunctionID [FunctionIDSize]byte

// FunctionSpec defines the spec of function
...
// Event define the struct of event
type Event struct {
	Inputs    []Argument
	Anonymous bool
}

// Spec defines the struct of abi
type Spec struct {
...
// ArgumentJSON define the json struct of argument
...
// SpecJSON define the spec json of abi
...
// ReadAbiSpec return the spec of specBytes
func ReadAbiSpec(specBytes []byte) (*Spec, error) {
	var specJ []SpecJSON
...
// ReadAbiSpecFile return the abi spec
func ReadAbiSpecFile(filename string) (*Spec, error) {
...
// EVMTypeFromReflect convert a input type to an argument
...
// SpecFromFunctionReflect convert function to FunctionSpec
...
// SetFunctionID set the function
...
// Bytes return the bytes of FunctionID
func (fs FunctionID) Bytes() []byte {
	return fs[:]
}

// GetFunctionID return the FunctionID
...
// Pack pack the abi spec
func (abiSpec *Spec) Pack(fname string, args ...interface{}) ([]byte, error) {
...
// PackIntoStruct return the bytes?
...
// GetPackingTypes return the pack types
...
// UnpackIntoStruct unpack data into struct
